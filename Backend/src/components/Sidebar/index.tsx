...
import logo from '../../../public/images/logo/aifx_logo_ver.png'
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        icon: (
          <svg width="18"
            ...
            <g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="10" stroke="#ffffff" stroke-width="1.5"></circle>
              <path d="M12 17V17.5V18" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M12 6V6.5V7" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M15 9.5C15 8.11929 13.6569 7 12 7C10.3431 7 9 8.11929 9 9.5C9 10.8807 10.3431 12 12 12C13.6569 12 15 13.1193 15 14.5C15 15.8807 13.6569 17 12 17C10.3431 17 9 15.8807 9 14.5" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
        ),
        label: "Investments",
        route: "/investments",
      },
      {
        icon: (
          <svg width="18"
            height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
              <path d="M18 8V7.2C18 6.0799 18 5.51984 17.782 5.09202C17.5903 4.71569 17.2843 4.40973 16.908 4.21799C16.4802 4 15.9201 4 14.8 4H6.2C5.07989 4 4.51984 4 4.09202 4.21799C3.71569 4.40973 3.40973 4.71569 3.21799 5.09202C3 5.51984 3 6.0799 3 7.2V8M21 12H19C17.8954 12 17 12.8954 17 14C17 15.1046 17.8954 16 19 16H21M3 8V16.8C3 17.9201 3 18.4802 3.21799 18.908C3.40973 19.2843 3.71569 19.5903 4.09202 19.782C4.51984 20 5.07989 20 6.2 20H17.8C18.9201 20 19.4802 20 19.908 19.782C20.2843 19.5903 20.5903 19.2843 20.782 18.908C21 18.4802 21 17.9201 21 16.8V11.2C21 10.0799 21 9.51984 20.782 9.09202C20.5903 8.71569 20.2843 8.40973 19.908 8.21799C19.4802 8 18.9201 8 17.8 8H3Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
        ),
        label: "Wallet",
        route: "",
        children: [
          { label: "Main Wallet", route: "/wallet/main-wallet" },
          { label: "Add Fund", route: "/wallet/add-fund" },
        ]
      },
      {
        icon: (
      ...
      },
      {
        ...
        route: "",
        children: [
          { label: "Weekly Roi", route: "/settings/weekly-roi" },
          { label: "Team Roi", route: "/settings/team-roi" },
          { label: "Direct Referral", route: "/settings/direct-referral" },
        ]
      },
      // {
      //   icon: (
